                    ...
                    <div style={{ flex: 1, padding: '1rem', overflowY: 'auto', background: 'var(--background-page)', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {messages.map((m, i) => (
                            <div key={i} style={{
                                ...
                                {m.codeSnippet && (
                                    <div style={{ marginTop: '0.75rem', background: '#1e1e1e', borderRadius: '6px', overflow: 'hidden' }}>
                                        <div style={{ background: '#2d2d2d', padding: '0.25rem 0.5rem', fontSize: '0.7rem', color: '#aaa', borderBottom: '1px solid #333' }}>
                                            Code Snippet
                                        </div>
                                        <pre style={{ margin: 0, padding: '0.75rem', overflowX: 'auto', fontSize: '0.8rem', color: '#d4d4d4', fontFamily: 'monospace' }}>
